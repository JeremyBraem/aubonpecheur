            ...
            <div class="md:flex md:flex-col">
                ...
                <div class="md:flex md:flex-row">
                    ...
                    <div class="md:w-2/4 lg:w-2/5 md:p-5">
                        <img src="<?php echo $imageFeeder->getNomImageFeeder(); ?>" style="border: 1px solid #000000;" class="w-56 h-56 m-auto my-5 md:w-[400px] md:h-[400px]">
                    </div>

                    <div class="md:w-2/4 lg:w-3/5 md:py-10 md:px-5">

                        <div class="w-2/3 m-auto md:w-auto text-center md:text-left">
                            <h1 class="text-[20px] md:text-[24px] font-semibold"><?php echo $feeder->getNomFeeder(); ?></h1>
                            <h2 class="text-[16px] md:text-[20px]"><?php echo $feeder->getMarqueFeeder(); ?></h2>
                        </div>

                        <div class="p-6 md:px-0 py-5">
                            <p class="text-[12px] md:text-[14px] lg:text-[16px]"><?php echo $feeder->getDescriptionFeeder(); ?></p>
                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="flex flex-col w-2/3 m-auto md:w-auto md:flex-row">
                                ...
                                <?php if ($feeder->getPromoFeeder() == 1) { ?>
                                ...
                                <?php if ($feeder->getStockFeeder() == 1) { ?>
                ...
                <div class="bg-[#426EC2]">
                    ...
                    <div class="mt-10 p-5 md:my-2 w-2/3 md:p-5 md:mx-10">
                        ...
                        <div class="flex">
                            <p class="text-[#fcfcfc] text-[12px] md:text-[20px] mr-5">Longueur : <?php echo $feeder->getLongueurFeeder(); ?>cm</p>
                            <p class="text-[#fcfcfc] text-[12px] md:text-[20px] mr-5">Poids : <?php echo $feeder->getPoidsFeeder(); ?>kg</p>
                            <p class="text-[#fcfcfc] text-[12px] md:text-[20px]">Diamètre : <?php echo $feeder->getDiametreFeeder(); ?>cm</p>
                        </div>
