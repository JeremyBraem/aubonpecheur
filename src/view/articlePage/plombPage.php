                ...
                <div class="bg-[#426EC2]">
                    ...
                    <div class="mt-10 p-5 md:my-2 w-2/3 md:p-5 md:mx-10">
                        ...
                        <div class="flex">
                            ...
                            <p class="text-[#fcfcfc] text-[12px] md:text-[20px] mr-5">Poids : <?php echo $plomb->getPoidsPlomb(); ?>kg</p>
                            <p class="text-[#fcfcfc] text-[12px] md:text-[20px]">Diamètre : <?php echo $plomb->getDiametrePlomb(); ?>cm</p>
                        </div>
