    ...
    <main>
        ...
        <section class="w-2/3 m-auto py-5">
            ...
            <div class="bg-[#fcfcfc] w-2/3 m-auto py-4 md:p-6">
                <h1 class="text-center font-semibold">Vos Informations Personnelles</h1>
            </div>

            <div class="md:w-2/3 m-auto">
                <p>Chez Au Bon Pêcheur, nous prenons la protection de vos informations personnelles très au sérieux. Nous collectons, utilisons et protégeons vos données conformément à notre Politique de Confidentialité. Voici quelques points clés :</p>
                <ul>
                    <li>Quelles informations nous collectons et pourquoi.</li>
                    ...
                    <li>Comment nous contacter pour des questions sur la vie privée.</li>
                </ul>
                Pour en savoir plus, veuillez consulter notre Politique de Confidentialité complète sur [insérer le lien vers la page Politique de Confidentialité].
            </div>
