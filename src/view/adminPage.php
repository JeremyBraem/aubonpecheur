                            ...
                            <tbody>
                                <?php foreach ($allProduits as $produit) { ?>
                                    <tr>
                                        ...
                                        <td class="px-4 py-3"><?php echo $produit['type'] ?></td>
                                        ...
                                        <td class="px-4 py-3 flex items-center justify-end">
                                            ...
                                            <button id="canne-dropdown-button-<?php echo $produit['id_produit'] ?>" data-dropdown-toggle="canne-dropdown-<?php echo $produit['id_produit'] ?>" class="inline-flex items-center text-sm font-medium hover:bg-gray-100  text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none " type="button">
                                                <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                                </svg>
                                            </button>

                                            <div id="canne-dropdown-<?php echo $produit['id_produit'] ?>" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow">

                                                <ul class="py-1 text-sm" aria-labelledby="canne-dropdown-button-<?php echo $produit['id_produit'] ?>">

                                                    <li>
                                                        <button type="button" value="<?php echo $produit['id_produit'] ?>" name="id_produit" data-modal-target="updateCanneModal-<?php echo $produit['id_produit'] ?>" data-modal-toggle="updateCanneModal-<?php echo $produit['id_produit'] ?>" class="edit-button flex w-full items-center py-2 px-4 hover:bg-gray-100">
                                                    ...
                                                    <li>
                                                        <button type="button" value="<?php echo $produit['id_produit'] ?>" name="id_produit" data-modal-target="readCanneModal-<?php echo $produit['id_produit'] ?>" data-modal-toggle="readCanneModal-<?php echo $produit['id_produit'] ?>" class="flex w-full items-center py-2 px-4 hover:bg-gray-100">
                                                            <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                    ...
                                                    <li>
                                                        <button type="button" value="<?php echo $produit['id_produit'] ?>" name="id_produit" data-modal-target="deleteCanneModal-<?php echo $produit['id_produit'] ?>" data-modal-toggle="deleteCanneModal-<?php echo $produit['id_produit'] ?>" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 text-red-500">
