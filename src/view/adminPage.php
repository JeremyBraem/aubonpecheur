        ...
        <section class="bg-gray-50 p-3 sm:p-5 antialiased">
            ...
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                <div class="relative">
                                        ...
                                        <td class="px-4 py-3 flex items-center justify-end">
                                            ...
                                            <div id="<?php echo $produit->getNomGenre() ?>-dropdown-<?php echo $produit->getIdProduit() ?>" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow">
                                                ...
                                                <ul class="py-1 text-sm" aria-labelledby="<?php echo $produit->getNomGenre() ?>-dropdown-button-<?php echo $produit->getIdProduit() ?>">
                                                    ...
                                                    <li>
                                                        <button type="button" value="<?php echo $produit->getIdProduit() ?>" name="id_produit" 
                                                        data-modal-target="update-<?php echo $produit->getNomGenre() ?>Modal-<?php echo $produit->getIdProduit() ?>" 
                                                        data-modal-toggle="update-<?php echo $produit->getNomGenre() ?>Modal-<?php echo $produit->getIdProduit() ?>" 
                                                        class="edit-button flex w-full items-center py-2 px-4 hover:bg-gray-100">
                    ...
                    <div class="flex justify-center mb-10 bg-[#fcfcfc]">
                    <div class="flex items-center justify-between border-t bg-[#fcfcfc] px-4 py-3 sm:px-6">
                        <div class="flex flex-1 justify-between sm:hidden">
                            <a href="#" class="relative inline-flex items-center rounded-md border border-gray-300 bg-[#fcfcfc] px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">Previous</a>
                            <a href="#" class="relative ml-3 inline-flex items-center rounded-md border border-gray-300 bg-[#fcfcfc] px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">Next</a>
                        </div>
                        <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                            <div>
                                <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination" id="pagination">
                                    <?php if ($currentpage > 1) { ?>
                                        <a href="/admin&page=<?php if(isset($_GET['page'])) {echo $_GET['page'] - 1;} ?>" class="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
                                    ...
                                    <?php for ($i = 1; $i <= $totalPages; $i++) { ?>
                                        <a class="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 focus:z-20 focus:outline-offset-0" href="/admin&page=<?php echo $i ?>"><?php echo $i ?></a>
                                    <?php } ?>

                                    <?php if ($currentpage < $totalPages) { ?>
                                        <a href="/admin&page=<?php if(isset($_GET['page'])){ echo $_GET['page'] + 1; }else{ echo 2;}  ?>" class="relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
