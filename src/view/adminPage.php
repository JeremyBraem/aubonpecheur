                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 flex items-center justify-end">
                                            ...
                                            <div id="canne-dropdown-<?php echo $produit['id_produit'] ?>" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow">
                                                ...
                                                <ul class="py-1 text-sm" aria-labelledby="canne-dropdown-button">

                                                    <li>
                                                        <button type="button" value="<?php echo $produit['id_produit'] ?>" data-modal-target="updateCanneModal-<?php echo $produit['id_produit'] ?>" data-modal-toggle="updateCanneModal-<?php echo $produit['id_produit'] ?>" class="edit-button flex w-full items-center py-2 px-4 hover:bg-gray-100">
                                                    ...
                                                    <li>
                                                        <button type="button" value="<?php echo $produit['id_produit'] ?>" name="canne_id" data-modal-target="readCanneModal-<?php echo $produit['id_produit'] ?>" data-modal-toggle="readCanneModal-<?php echo $produit['id_produit'] ?>" class="flex w-full items-center py-2 px-4 hover:bg-gray-100">
                                                            <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                    ...
                                                    <li>
                                                        <button type="button" value="<?php echo $produit['id_produit'] ?>" name="canne_id" data-modal-target="deleteCanneModal-<?php echo $produit['id_produit'] ?>" data-modal-toggle="deleteCanneModal-<?php echo $produit['id_produit'] ?>" class="flex w-full items-center py-2 px-4 hover:bg-gray-100  text-red-500 ">
