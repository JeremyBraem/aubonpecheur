    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow  sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 ">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center  " data-modal-toggle="updateMoulinetModal-<?php echo $article['id'] ?>">
            ...
            <form action="admin.php?action=UpdateMoulinetTraitement" method="post" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="nom_moulinet" id="nom_moulinet" value="<?php echo $article['nom'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  " placeholder="Type product name" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="poids_moulinet" id="poids_moulinet" value="<?php echo $article['poids'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  " placeholder="Poids en kg" required>
                    </div>

                    <div>
                        <label for="price_moulinet" class="block mb-2 text-sm font-medium text-gray-900 ">Ratio</label>
                        <input type="number" name="ratio_moulinet" id="ratio_moulinet" value="<?php echo $article['ratio'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  " placeholder="Ratio en m" required>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="promo_moulinet" name="promo_moulinet" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5  ">
                    ...
                    <div>
                        ...
                        <select id="stock_moulinet" name="stock_moulinet" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5  ">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="description_moulinet" id="description_moulinet" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500  " placeholder="Write product description here"></textarea>
                    </div>
