            ...
            <form action="admin.php?action=updateMoulinetTraitement" method="post" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo $moulinet->getNomProduit(); ?>" name="nom_produit" id="nom_produit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Type product name" required>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="description_images" value="<?php echo $moulinet->getDescriptionImage(); ?>" id="description_images" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500" placeholder="Write product description here"><?php echo $moulinet->getDescriptionProduit(); ?></textarea>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="description_produit" id="description_produit" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500" placeholder="Write product description here"><?php echo $moulinet->getDescriptionProduit(); ?></textarea>
                    </div>
