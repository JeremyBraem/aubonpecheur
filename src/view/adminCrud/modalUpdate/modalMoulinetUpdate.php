<?php foreach($moulinetInfo as $moulinet) { ?>
<div id="update-moulinetModal-<?php echo $produit['id_produit'] ?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        <!-- Modal content -->
        <div class="relative p-4 bg-white rounded-lg shadow">
            <!-- Modal header -->
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5">
                <h3 class="text-lg font-semibold text-gray-900 ">Modifier une moulinet</h3>
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-target="update-moulinetModal-<?php echo $produit['id_produit'] ?>" data-modal-toggle="update-moulinetModal-<?php echo $produit['id_produit'] ?>">
            ...
            <form action="admin.php?action=updateMoulinetTraitement" method="post" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="number" name="poids_moulinet" value="<?php echo $moulinet['poids_moulinet']; ?>" id="poids_moulinet" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Poids en kg" required>
                    </div>

                    <div>
                        <label for="ratio_moulinet" class="block mb-2 text-sm font-medium text-gray-900 ">Ratio</label>
                        <input type="number" name="ratio_moulinet" value="<?php echo $moulinet['ratio_moulinet']; ?>" id="ratio_moulinet" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Longueur en m" required>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="description_produit" id="description_produit" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500" placeholder="Ecrire une description"><?php echo $produit['description_produit']; ?></textarea>
                    </div>
