            ...
            <form action="admin.php?action=updateHameconTraitement" method="post" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="number" name="poids_hamecon" value="<?php echo $hamecon->getPoidsHamecon(); ?>" id="poids_hamecon" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Poids en kg" required>
                    </div>

                    <div>
                        <label for="longueur_hamecon" class="block mb-2 text-sm font-medium text-gray-900 ">Longueur :</label>
                        <input type="number" name="longueur_hamecon" value="<?php echo $hamecon->getLongueurHamecon(); ?>" id="longueur_hamecon" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Longueur en m" required>
                    </div>

                    <div>
                        <label for="prix_produit" class="block mb-2 text-sm font-medium text-gray-900 ">Prix :</label>
                        <input type="number" name="prix_produit" id="prix_produit" value="<?php echo $hamecon->getPrixProduit(); ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Prix en euro" required>
                    </div>
