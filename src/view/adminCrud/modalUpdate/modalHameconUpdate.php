<div id="update-hameconModal-<?php echo $hamecon->getIdProduit() ?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-target="update-hameconModal-<?php echo $hamecon->getIdProduit() ?>" data-modal-toggle="update-hameconModal-<?php echo $hamecon->getIdProduit() ?>">
            ...
            <form action="admin.php?action=updateHameconTraitement" method="post" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        <label for="nom" class="block mb-2 text-sm font-medium text-gray-900">Nom de la hamecon</label>
                        <input type="text" value="<?php echo $hamecon->getNomProduit(); ?>" name="nom_produit" id="nom_produit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Nom de la hamecon" required>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="description_images" value="<?php echo $hamecon->getDescriptionImage(); ?>" id="description_images" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500" placeholder="Écrire une description de l'image"><?php echo $hamecon->getDescriptionImage(); ?></textarea>
                    </div>

                    <div>
                        <label for="poids_hamecon" class="block mb-2 text-sm font-medium text-gray-900 ">Poids :</label>
                        <input type="number" step="0.01" name="poids_hamecon" value="<?php echo $hamecon->getPoidsHamecon(); ?>" id="poids_hamecon" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Poids en kg" required>
                    </div>

                    <div>
                        <label for="longueur_hamecon" class="block mb-2 text-sm font-medium text-gray-900 ">Longueur :</label>
                        <input type="number" step="0.01" name="longueur_hamecon" value="<?php echo $hamecon->getLongueurHamecon(); ?>" id="longueur_hamecon" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Longueur en m" required>
                    </div>

                    <div>
                        <label for="prix_produit" class="block mb-2 text-sm font-medium text-gray-900 ">Prix :</label>
                        <input type="number" step="0.01" name="prix_produit" id="prix_produit" value="<?php echo $hamecon->getPrixProduit(); ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Prix en euro" required>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="description_produit" id="description_produit" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500" placeholder="Écrire une description"><?php echo $hamecon->getDescriptionProduit(); ?></textarea>
                    </div>

                </div>
                <input type="hidden" value="<?php echo $hamecon->getIdProduit(); ?>" name="id_produit">
