<div id="updateCanneModal-<?php echo $article['id'] ?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow  sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 ">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center  " data-modal-toggle="updateCanneModal-<?php echo $article['id'] ?>">
            ...
            <form action="admin.php?action=UpdateCanneTraitement" method="post" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="nom_canne" id="nom_canne" value="<?php echo $article['nom'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  " placeholder="Type product name" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="poids_canne" id="poids_canne" value="<?php echo $article['poids'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  " placeholder="Poids en kg" required>
                    </div>

                    <div>
                        <label for="longueur_canne" class="block mb-2 text-sm font-medium text-gray-900 ">Longueur</label>
                        <input type="number" name="longueur_canne" id="longueur_canne" value="<?php echo $article['longueur'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  " placeholder="Longueur en m" required>
                    </div>

                    <div>
                        <label for="prix_canne" class="block mb-2 text-sm font-medium text-gray-900 ">Prix</label>
                        <input type="number" name="prix_canne" id="prix_canne" value="<?php echo $article['prix'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  " placeholder="Longueur en m" required>
                    </div>
                    ...
                    <input type="hidden" name="id_canne" value="<?php echo $article['id'] ?>">
