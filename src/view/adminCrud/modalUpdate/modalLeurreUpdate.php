    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow  sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 ">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center  " data-modal-toggle="updateLeurreModal-<?php echo $article['id'] ?>">
            ...
            <form action="admin.php?action=UpdateLeurreTraitement" method="post" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        <label for="nom" class="block mb-2 text-sm font-medium text-gray-900 ">Nom de la leurre</label>
                        <input type="text" name="nom_leurre" id="nom_leurre" value="<?php echo $article['nom'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  " placeholder="Type product name" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="poids_leurre" id="poids_leurre" value="<?php echo $article['poids'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  " placeholder="Poids en kg" required>
                    </div>

                    <div>
                        <label for="couleur_leurre" class="block mb-2 text-sm font-medium text-gray-900 ">Couleur</label>
                        <input type="type" name="couleur_leurre" id="couleur_leurre" value="<?php echo $article['couleur'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  " placeholder="Couleur" required>
                    </div>
