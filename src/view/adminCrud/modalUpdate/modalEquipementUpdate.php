    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow  sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 ">
                <h3 class="text-lg font-semibold text-gray-900 ">Modifier un equipement</h3>
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center  " data-modal-toggle="updateEquipementModal-<?php echo $article['id'] ?>">
            ...
            <form action="admin.php?action=UpdateEquipementTraitement" method="post" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        <label for="categorie_equipement" class="block mb-2 text-sm font-medium text-gray-900 ">Catégorie</label>
                    ...
                    <div class="sm:col-span-2">
                        <label for="detail_equipement" class="block mb-2 text-sm font-medium text-gray-900 ">Détails</label>
