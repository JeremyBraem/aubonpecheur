<div id="updateEquipementModal-<?php echo $equipement->getIdEquipement() ?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="updateEquipementModal-<?php echo $equipement->getIdEquipement() ?>">
            ...
            <form action="admin.php?action=UpdateEquipementTraitement" method="post" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="nom_equipement" id="nom_equipement" value="<?php echo $equipement->getNomEquipement() ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 " placeholder="Type product name" required>
                    </div>
                    ...
                    <div>
                        <label for="detail_equipement" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Detail</label>
                        <input type="number" name="detail_equipement" id="detail_equipement" value="<?php echo $equipement->getTypeEquipement() ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 " placeholder="Detail en kg" required>
                    </div>

                    <div>
                        <label for="categorie_equipement" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Categorie</label>
                    ...
                    <div>
                        ...
                        <select id="promo_equipement" name="promo_equipement" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 ">
                    ...
                    <div>
                        ...
                        <select id="stock_equipement" name="stock_equipement" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 ">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="description_equipement" id="description_equipement" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 " placeholder="Write product description here"></textarea>
                    </div>

                    <input type="hidden" name="id_equipement" value="<?php echo $equipement->getIdEquipement() ?>">
