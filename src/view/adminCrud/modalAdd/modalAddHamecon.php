    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5">
                <h3 class="text-lg font-semibold text-gray-900 ">Ajouter un hameçon</h3>
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-target="createHameconModal" data-modal-toggle="createHameconModal">
            ...
            <form action="admin.php?action=addHameconTraitement" method="post" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        <label for="nom" class="block mb-2 text-sm font-medium text-gray-900">Nom d'hamecon</label>
                        <input type="text" name="nom_produit" id="nom_produit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Nom de l'hameçon" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="poids_hamecon" id="poids_hamecon" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Poids en g" required>
                    </div>

                    <div>
                        <label for="longueur_hamecon" class="block mb-2 text-sm font-medium text-gray-900 ">Longueur</label>
                        <input type="number" step="0.01" name="longueur_hamecon" id="longueur_hamecon" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Longueur en m" required>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="description_produit" id="description_produit" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500" placeholder="Écrire une description de l'hameçon"></textarea>
                    </div>
