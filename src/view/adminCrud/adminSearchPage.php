                        ...
                        <div class="w-full md:w-1/2">
                            ...
                            <form class="flex items-center" action="admin.php?action=search" method="post">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" id="simple-search" name="keywords" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2" placeholder="Rechercher">
                                </div>
