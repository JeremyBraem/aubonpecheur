...
<head>
    ...
    <title>Page d'articles <?php echo $_GET['categorie'] ?></title>
</head>
                                ...
                                <div>
                                    <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination" >
                                        ...
                                        <?php if ($currentpage < $totalPages) { ?>
                                            <a href="/promotion&page=<?php if(isset($_GET['page'])){ echo $_GET['page'] + 1; }else{ echo 2;}  ?>" class="relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
