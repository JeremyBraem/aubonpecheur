...
<head>
    ...
    <title>Page d'articles <?php echo $_GET['categorie'] ?> - Au Bon Pêcheur</title>
</head>
                                ...
                                <div>
                                    <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination" >
                                        ...
                                        <?php for ($i = 1; $i <= $totalPages; $i++) { ?>
                                            <a class="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 focus:z-20 focus:outline-offset-0" href="/article/<?php echo $_GET['categorie'] ?>&page=<?php echo $i ?>"><?php echo $i ?></a>
                                        <?php } ?>
