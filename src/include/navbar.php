<nav class="py-8 relative p-2 flex justify-between items-center bg-[#426EC2]">
    <div class="lg:hidden">
    </div>
    <div class="lg:hidden">
    ...
    <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
        <li><a class="text-sm text-white" href="#">Home</a></li>
        <li><a class="text-sm text-white" href="#">About Us</a></li>
        <li><a class="text-sm text-white" href="#">Services</a></li>
        <li><a class="text-sm text-white" href="#">Pricing</a></li>
        <li><a class="text-sm text-white" href="#">Contact</a></li>
    </ul>
</nav>
