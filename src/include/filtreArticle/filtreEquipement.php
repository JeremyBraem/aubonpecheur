        ...
        <div class="py-3">
            ...
            <div class="flex flex-col bg-white ">
                ...
                <?php foreach ($typeEquipements as $typeEquipement) { ?>
                    <div>
                        <input type="checkbox" value="<?php echo $typeEquipement->getNomTypeEquipement(); ?>" class="filtre">
                        <label><?php echo $typeEquipement->getNomTypeEquipement(); ?></label>
                    </div>
                <?php } ?>
        ...
        <details class="bg-[#fcfcfc] py-3 p-5 w-52">
            ...
            <div class="py-3">
                <div class="flex flex-col bg-white">
                    <?php foreach ($typeEquipements as $typeEquipement) { ?>
                        <div>
                            <input type="checkbox" id="<?php echo $typeEquipement->getNomTypeEquipement(); ?>" value="<?php echo $typeEquipement->getNomTypeEquipement(); ?>" class="filtre">
                            <label><?php echo $typeEquipement->getNomTypeEquipement(); ?></label>
                        </div>
                    <?php } ?>
                </div>
